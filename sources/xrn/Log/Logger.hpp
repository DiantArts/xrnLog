...
///////////////////////////////////////////////////////////////////////////
#define XRN_LOG(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__ XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_SUCCESS(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::success XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_NOTE(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::note XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_INFO(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::info XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_TRACE(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::trace XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_DEBUG(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::debug XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_WARN(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::warning XRN_VA_ARGS(__VA_ARGS__));
...
///////////////////////////////////////////////////////////////////////////
#define XRN_ERROR(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::error XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Output logs
///////////////////////////////////////////////////////////////////////////
#define XRN_FATAL(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::fatal XRN_VA_ARGS(__VA_ARGS__));
...
///////////////////////////////////////////////////////////////////////////
#define XRN_THROW(...) \
    ::xrn::Logger::get().log(__FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::fatalError XRN_VA_ARGS(__VA_ARGS__)); \
...
#define XRN_ASSERT(condition, ...) \
    ::xrn::Logger::get().massert((condition), __FILE__, __FUNCTION__, __LINE__ XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Same as assert from <cassert> but just print error
///////////////////////////////////////////////////////////////////////////
#define XRN_SASSERT(condition, ...) \
    ::xrn::Logger::get().sassert((condition), __FILE__, __FUNCTION__, __LINE__ XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Same as assert from <cassert>
///////////////////////////////////////////////////////////////////////////
#define XRN_FATAL_ASSERT(condition, ...) \
    ::xrn::Logger::get().massert((condition), __FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::fatalError XRN_VA_ARGS(__VA_ARGS__));

///////////////////////////////////////////////////////////////////////////
/// \brief Same as assert from <cassert>
///////////////////////////////////////////////////////////////////////////
#define XRN_FATAL_SASSERT(condition, ...) \
    ::xrn::Logger::get().sassert((condition), __FILE__, __FUNCTION__, __LINE__, ::xrn::Logger::Level::fatalError XRN_VA_ARGS(__VA_ARGS__));
